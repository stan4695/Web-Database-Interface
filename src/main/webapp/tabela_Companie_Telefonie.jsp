...
<html>
    <head>
        ...
        <title>Tabela Companie_Telefonie</title>
    ...
    <body>
        ...
        <form action="sterge_Companie_Telefonie.jsp" method="post">
            <table border="1" align="center">
                ...
                <%
                    ...
                    long x;
                    while (rs.next()) {
                        x = rs.getInt("idCompanieTelefonie");
                %>
                <tr>
                    <td class = "checkbox"><input type="checkbox" name="primarykey" value="<%= x%>" /></td><td><%= x%></td>
                    <td class = "id"><%= rs.getString("nume")%></td>
